\begin{titlepage}
	...
	\begin{center}
		\vspace*{5cm}
        \Huge{Latenz im I2P-Netzwerk (vorschlag)\textbf{}} \\
		\Large{Kann eine niedrigere Latenz erreicht werden mit einem grösseren Netzwerk}\\
		\vspace{0.5em}
...
\vspace{0.6cm}
\noindent
\textbf{Studentin / Student 1:} Moritz Küttel
