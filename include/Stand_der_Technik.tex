...
Im ersten Abschnitt~\fullref{sec:techintro} gibt es einen Einstieg in Anonymisierungsnetzwerke und die Begrifflichkeiten allgemein.
Im Abschnitt~\fullref{sec:technischeKonzepte} wird genauer auf die Technologie von I2P eingegangen.
...
Komplette Anonymität wäre dann erreicht, wenn nicht auf die wahre Identität eines Benutzers geschlossen werden kann.
